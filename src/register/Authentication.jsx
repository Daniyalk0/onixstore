...
function Authentication() {
  ...
  useEffect(() => {
    const hasAnimatedAuth = sessionStorage.getItem("hasAnimatedAuth");
    ...
    if (!hasAnimatedAuth) {
      ...
      sessionStorage.setItem("hasAnimatedAuth", "true");
    }else{
      gsap.fromTo(
        ".animate-me",
        {
