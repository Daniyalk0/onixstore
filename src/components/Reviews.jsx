...
function Reviews() {
  ...
  return (
    <Container>
      <div
        className="w-full px-6 my-10 lg:px-8 bg-white xs:my-[-1px] xs:py-10 "
        ref={containerRef}
      >
        ...
        >
          <div className="xl:w-full flex xl:justify-center xl:items-center">
            <SwiperSlide className="flex justify-center items-center z-[1] animate-me3 xxs:mr-7 xs:mr-0 mr-0 ">
              <div className=" font-satoshi px-[8vw] py-8 gap-2 flex flex-col xs:px-[4vw] bg-[#ededed]  mt-[50px] rounded-xl md:w-[43vw] md:px-[3vw] md:mt-[90px] lg:w-full xl:px-4 xl:w-[25vw] xl:mt-[50px]  ">
                <div className="stars w-[14vw] md:w-[15vw] xl:w-[6vw] xxs:px-0">
                  <Rating
                    style={{ maxWidth: 400 }}
                    value={2}
                    readOnly
            ...
            <SwiperSlide className="flex justify-center items-center animate-me3 xxs:mr-7 xs:mr-0 mr-0">
              <div className=" font-satoshi px-[8vw] py-8 gap-2 flex flex-col xs:px-[4vw] bg-[#ededed] mt-[50px] rounded-xl md:w-[43vw] md:px-[3vw] md:mt-[90px]  lg:w-full xl:px-4 xl:w-[25vw] xl:mt-[50px]">
            ...
            <SwiperSlide className="flex justify-center items-center animate-me3 xxs:mr-0">
              <div className=" font-satoshi px-[8vw] py-8 gap-2 flex flex-col xs:px-[4vw] bg-[#ededed] mt-[50px] rounded-xl md:w-[43vw] md:px-[3vw] md:mt-[90px]  lg:w-full xl:px-4 xl:w-[25vw] xl:mt-[50px]">
                <div className="stars w-[14vw] md:w-[15vw] xl:w-[6vw]">
                  <Rating
                    style={{ maxWidth: 400 }}
