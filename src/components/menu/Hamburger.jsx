  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full flex  justify-between text-xl font-semibold font-satoshi items-center mt-8 xxs:mt-[-5.5vw]">
        ...
        <GlobalBtn
          ...
          text={"view cart"}
          route={"/cartPage"}
          className={"w-full h-11 text-[3vw] mt-12 xs:mt-6 xxs:mb-[6vw]"}
        />
      </div>
